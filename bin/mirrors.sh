...
HADOOP_MIRRORS[0]='http://apache.petsads.us/hadoop/common/hadoop-version/hadoop-version.tar.gz'
HADOOP_MIRRORS[1]='http://www.poolsaboveground.com/apache/hadoop/common/hadoop-version/hadoop-version.tar.gz'
HADOOP_MIRRORS[2]='http://mirror.cc.columbia.edu/pub/software/apache/hadoop/common/hadoop-version/hadoop-version.tar.gz'

ZOOKEEPER_MIRRORS[0]='http://mirrors.gigenet.com/apache/zookeeper/zookeeper-version/zookeeper-version.tar.gz'
